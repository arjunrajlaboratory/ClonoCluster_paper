...
ggsave(plot = up, "../Figs/Fig4_umap.pdf", height = 6/5, width = 6)
...
ggsave(plot = pcp, "../Figs/Fig4_pcs.pdf", height = 12/5, width = 6)
...
ggsave(plot = p, "../Figs/Variance_plot.pdf", height = 2.5, width = 2.5)
